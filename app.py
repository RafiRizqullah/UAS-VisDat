...
st.set_page_config(page_title = "Data Penindakan Pelanggaran Lalu-lintas dan Angkutan Jalan Tahun 2021 Bulan April",
                   page_icon = ":bar_chart:",
                   layout = "wide"
                   )
# ---- READ EXCEL ----
...
df = pd.read_excel(
    io = "data-penindakan-pelanggaran-lalu-lintas-dan-angkutan-jalan-tahun-2021-bulan-april.xlsx",
    engine = 'openpyxl',
    )
...
# ---- MAINPAGE ----
st.header(":bar_chart: Data Penindakan Pelanggaran Lalu Lintas dan Angkutan Jalan Tahun 2021 Bulan April")
st.markdown("##")
...
fig_product_sales = px.bar(
    ...
    color_discrete_sequence=["#800000"] * len(sales_by_product_line),
